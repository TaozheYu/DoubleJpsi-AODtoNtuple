...
#include "MakeCorrector_Genonly.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void MakeCorrector_Genonly(const char *mc, const char *type){
  //TString Mc = mc; TString Type = type;
  char openTree[500];   sprintf(openTree, "GenAnalyzer/gen_tree");
  char openFile[500];   sprintf(openFile, "/publicfs/cms/user/yutz/Double_JPci/TsHAODNtuple/%sToJJ_13TeV_pythia8_%s_genonly_2016.root",mc,type); 
