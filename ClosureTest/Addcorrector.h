...
TFile *filecorrector; //= new TFile("corrector_DPS_official.root");
TH2F  *h_w_acc_eta; //= (TH2F*) filecorrector->Get("h_w_acc_eta");
TH2F  *h_w_acc_pt;  //= (TH2F*) filecorrector->Get("h_w_acc_pt");
TH2F  *h_w_reco;    //= (TH2F*) filecorrector->Get("h_w_reco");
TH2F  *h_w_eff;     //= (TH2F*) filecorrector->Get("h_w_eff");
TH2F  *h_w_vtx;     //= (TH2F*) filecorrector->Get("h_w_vtx");
TH2F  *h_w_HLT;     //= (TH2F*) filecorrector->Get("h_w_HLT");
TH2F  *h_w_evt;     //= (TH2F*) filecorrector->Get("h_w_evt");
