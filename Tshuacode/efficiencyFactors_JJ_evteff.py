...
from ROOT import *
from LoadData_JJ_eff_Mix18 import *
...
#        cut_reco_evt = "fourmu_mass_allcuts>0"   
        ...
        '''
        Tree[Sample].Draw("ups1_mass_GenMatched_ID_OS_VTX>> " +processBin+"reco_eff_id_vtx_ab","("+recoweight+")*("+cut_reco_id_vtx_ups_a+" && "+cut_ups_reco_ID_OS_VTX_pta+" && "+cut_ups_reco_ID_OS_VTX_ya+" && "+cut_reco_id_vtx_ups_b+" &&  "+cut_ups_reco_ID_OS_VTX_ptb+" && "+cut_ups_reco_ID_OS_VTX_yb+" && "+cut_mu_reco_eta_a+" && "+cut_mu_reco_pta_a+" && "+cut_mu_reco_eta_b+" && "+cut_mu_reco_pta_b+")","goff")
        Tree[Sample].Draw("fourMuFit_Mass[0] >> " +processBin+"reco_eff_trg_evt","("+recoweight+")*("+cut_trg_evt+" && "+cut_ups_reco_ID_OS_VTX_pta+" && "+cut_ups_reco_ID_OS_VTX_ya+" && "+cut_ups_reco_ID_OS_VTX_ptb+" && "+cut_ups_reco_ID_OS_VTX_yb+" && "+cut_ups_reco_ID_OS_VTX_yb+" && "+cut_mu_reco_eta_a+" && "+cut_mu_reco_pta_a+" && "+cut_mu_reco_eta_b+" && "+cut_mu_reco_pta_b+")","goff")
        Tree[Sample].Draw("fourMuFit_Mass[0] >> " +processBin+"reco_eff_evt","("+recoweight+")*("+cut_reco_evt+" && "+cut_ups_reco_ID_OS_VTX_pta+" && "+cut_ups_reco_ID_OS_VTX_ya+" && "+cut_ups_reco_ID_OS_VTX_ptb+" && "+cut_ups_reco_ID_OS_VTX_yb+" && "+cut_ups_reco_ID_OS_VTX_yb+" && "+cut_mu_reco_eta_a+" && "+cut_mu_reco_pta_a+" && "+cut_mu_reco_eta_b+" && "+cut_mu_reco_pta_b+")","goff")
