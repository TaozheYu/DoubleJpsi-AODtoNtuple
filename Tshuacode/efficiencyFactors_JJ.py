...
def geteffs(channel, List, obs_bins_pt, obs_bins_y, obs_gen_pT, obs_gen_y, genbin_pt, genbin_y):
    ...
    for Sample in List:
        ...
        N_a_Origin[processBin] = 0
        N_a_Acc[processBin] = 0
        N_b_Origin[processBin] = 0
        N_b_Acc[processBin] = 0
        ...
        N_a_Origin[processBin] = Histos[processBin+"fs_a"].Integral()
        N_b_Origin[processBin] = Histos[processBin+"fs_b"].Integral()
        ...
        N_a_Acc[processBin] = Histos[processBin+"fid_a_etapt"].Integral()
        N_b_Acc[processBin] = Histos[processBin+"fid_b_etapt"].Integral()

        print processBin, "N_a_Origin: ", N_a_Origin[processBin], "N_b_Origin: ", N_b_Origin[processBin]
        print processBin, "N_a_Acc: ", N_a_Acc[processBin], "N_b_Acc: ", N_b_Acc[processBin]
...
with open('inputs_sig_JJ'+opt.OBSNAME+'.py', 'w') as f:
    f.write('N_a_Origin = '+str(N_a_Origin)+' \n')
    f.write('N_b_Origin = '+str(N_b_Origin)+' \n')
    f.write('N_a_Acc = '+str(N_a_Acc)+' \n')
    f.write('N_b_Acc = '+str(N_b_Acc)+' \n')
