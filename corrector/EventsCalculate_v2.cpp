...
void EventsCalculate_v2(const char *mc, const char *type){
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    */ 
    ...
    h_acc_eta_Jpsi->Fill(GENdimu_pt->at(0),GENdimu_y->at(0));    
    h_acc_eta_Jpsi->Fill(GENdimu_pt->at(1),GENdimu_y->at(1));    
